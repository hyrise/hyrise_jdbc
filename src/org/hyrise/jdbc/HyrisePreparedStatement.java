 ...
 * 
 */
public class HyrisePreparedStatement extends HyriseStatement implements PreparedStatement {

	// This is the actual data we use to format the input string
	ArrayList<String> parameters = new ArrayList<String>();
	
	String sql = null;
	

	public HyrisePreparedStatement(HyriseConnection c, String sql) {
		super(c);
		this.sql = sql;
	}
	...
	public void setBoolean(int parameterIndex, boolean x) throws SQLException {
		setString(parameterIndex, x ? "true" : "false");
	}
	...
	public boolean execute() throws SQLException {
		result = executeHyriseQuery(String.format(sql, parameters.toArray()), false);
		return true;
	}
